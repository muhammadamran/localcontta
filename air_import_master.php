  ...
  $cekref=mysql_query("SELECT rcd_hbl FROM tb_master_impor where rcd_hbl = '$hbl'");
    if (mysql_num_rows($cekref) == 0) {
      ...
      $query .= mysql_query("INSERT into tb_truck_assign(truck_job_id,rcd_id) values(' ','$last_id')");
        if($query){
          header("Location: ./air_import_master.php");                                                  
        } else {
...
<body onload="display_ct()">
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">[Airfreight] Import <i>Master</i></h1>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- /.row -->
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="well">
                ...
                <?php include 'modals/iou_modal_rcd_create_impor_air.php';?>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($con,"SELECT * FROM tb_master_impor WHERE rcd_status = 'New' AND rcd_mot = 'AIR' ");
