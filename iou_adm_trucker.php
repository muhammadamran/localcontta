                      ...
                      <div class="modal fade" id="delete<?= $row['trucker_id'];?>" role="dialog">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h4 class="modal-title"><b>[Delete]</b> Trucker</h4>
                            </div>
                            <form method="post" action=" ">
                              <div class="modal-body">
                                  <div class="form-group">
                                    <label>Are you sure delete this Trucker?</label>
                                    <h6>Trucker Name : <?= $row['trucker_name'];?></h6>
                                    <input type="hidden" name="uid" class="form-control" value="<?= $row['trucker_id'];?>" required>
                                  </div>
                                  <div class="form-group">
                                    <h6>Email : <?= $row['trucker_mail'];?></h6>
                                  </div>
                                  <div class="form-group">
                                    <h6>Phone : <?= $row['trucker_phone'];?></h6>
                                  </div>
                                  <div class="form-group">
                                    <h6>PIC : <?= $row['trucker_pic'];?></h6>
                                  </div>
                                  <div class="form-group">
                                    <h6>Address <br> <?= $row['trucker_address'];?></h6>
                                  </div>
                              </div>
                              <div class="modal-footer">
