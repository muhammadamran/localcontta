...
{    
  ...
  if($query)
    if ($dtype == 'PEB') {
      ...
      if ($uploadplus) {
        header("Location: ./exp_efile.php?ref=$ref");
      } 
    } elseif ($dtype == 'COO' ) {
                      ...
                      <div class="modal-body">
                        <form method="post" action=" " accept-charset="utf-8" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input type="file" style="height: 30px; font-size: 20px;background-image: url('searchicon.png');" name="form" class="form-control">
