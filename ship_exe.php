...
$rcd_exe_stuff_end      = $_POST['rcd_exe_stuff_end'];
$rcd_exe_con_no         = $_POST['rcd_exe_con_no'];
$rcd_exe_con_leave      = $_POST['rcd_exe_con_leave'];
$rcd_id                 = $_POST['rcd_id'];
$stufflate                 = $_POST['stufflate'];
$stuff_remark                 = $_POST['stuff_remark'];
...
if ($rcd_exe_stuff_end == '') {
  $rcd_exe_stuff_end_sql = $rcd_exe_stuff_end_now;
} else {
  $rcd_exe_stuff_end_sql = $rcd_exe_stuff_end;
}
...
if ($rcd_exe_con_cy == '') {
  ...
  $query = mysql_query("UPDATE tb_record_ship_exe SET rcd_exe_do_no='$rcd_exe_do_no',rcd_exe_liner='$rcd_exe_liner',rcd_exe_truck_arrived='$rcd_exe_truck_arrived_sql',rcd_exe_stuff_start='$rcd_exe_stuff_start_sql',rcd_exe_stuff_end='$rcd_exe_stuff_end_sql',rcd_exe_con_no='$rcd_exe_con_no',rcd_exe_con_leave='$rcd_exe_con_leave_sql',rcd_exe_con_cy='$rcd_exe_con_cy_sql', stufflate='$stufflate', stuff_remark = '$stuff_remark' where rcd_id='$rcd_id'");
  if($query){
...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Shipment Execution</h1>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- /.row -->
                  ...
                  <tbody>
                    ...
                    if(mysqli_num_rows($result)>0){
                      ...
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        echo "<td>" . $grep['stuffingschedule'] . "</td>";
                        ...
                        echo "<td>" . $row['stufflate'] . "</td>";
                        echo "<td>" . $row['stuff_remark'] . "</td>";
                        echo "<td align= ''>
                              ...
                              <form method="post" action=" ">
                                <div class="col-md-12">
                                  <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-6">
                                      <label>StuffingEnd</label>
                                      <input type="text" name="rcd_exe_stuff_end_now" value="<?php echo $row['rcd_exe_stuff_end'];?>" class="form-control" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                      <label>Input Here!</label>
                                      <input type="datetime-local" name="rcd_exe_stuff_end" class="form-control" >
                                    </div>
                                    <div class="form-group">
                                      <label>StuffLate Reason</label>
                                      <select name="stufflate" class="form-control">
                                        <option value="">---SELECT---</option>
                                        <option value="Delay Stuffing (PMI)">Delay WH Stuffing (PMI)</option>
                                        <option value="Delay Delivery Container">Delay Delivery Container (KN)</option>
                                      </select>
                                    </div>
                                    <div class="form-group">
                                      <label>StuffLate Remark</label>
                                      <input type="text" name="stuff_remark" value="<?php echo $row['stuff_remark'];?>" class="form-control" >
                                    </div>
                                    <div class="form-group">
