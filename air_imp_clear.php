...
{    
  ...
  $query = mysql_query("UPDATE tb_master_impor SET rcd_ata ='$ata',rcd_do_validation='$do_validation' where rcd_id='$rcd_id'");
...
//$query .= mysqli_query("UPDATE tb_master_impor SET rcd_coo ='$coo1' where rcd_id='$rcd_id'");
  if($query){
    mysqli_query("UPDATE tb_master_impor SET rcd_coo ='$coo1' where rcd_id='$rcd_id'");
    header("Location: ./imp_clear.php");                                                  
  } else {
    echo "Updated Failed - Please contact your administrator".mysql_error();
  }
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">[Airfreight] Import - Clearance</h1>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
                                ...
                                <div class="col-md-12">
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <label>COO</label>
                                      <select name="coo1" class="form-control" required>
