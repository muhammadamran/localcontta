...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">[Air] Import - <i>Report Process</i></h1>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- /.row -->
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <form action="air_import_report_process_to_csv.php" method="get">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($con,"SELECT * FROM tb_master_impor INNER JOIN tb_record_miles_import ON tb_master_impor.rcd_id=tb_record_miles_import.rcd_id  WHERE tb_master_impor.rcd_type = 'import' AND tb_master_impor.rcd_create_month='$monthnow' AND tb_master_impor.rcd_mot = 'AIR' AND tb_master_impor.rcd_create_year='$yearnow'");
