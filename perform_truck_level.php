      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            ...
            <?php // include 'include/perform_truck_diagram.php';?>          
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  <thead>
                    <tr>
                      ...
                      <th style='background-color: #FFFF99'>Truck Arrived</th>
                  ...
                  <tbody>
                    ...
                    if(mysqli_num_rows($result)>0){
                      ...
                      while($row = mysqli_fetch_array($result))
                      {
                        ...
                        echo "<td style='background-color: #FFFF99'>" . $row['rcd_exe_truck_arrived'] . "</td>";

                        /*$datetime1 = new DateTime($row['stuffingschedule']);
                        $datetime2 = new DateTime($row['rcd_exe_truck_arrived']);
                        $diff = $datetime1->diff($datetime2);

                        if ($row['rcd_exe_truck_arrived'] == '0000-00-00 00:00:00') {
                        ...
                        $showstamp2 = strtotime($row['rcd_exe_truck_arrived']);
                        $stampdiff = $showstamp1 - $showstamp2;
