...
{    
  ...
  $query = mysql_query("INSERT into tb_shipper values(' ','$user_name','$caddress','$email')");

  if($query){
    header("Location: ./iou_adm_shipper.php");                                                  
  } else {
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($con,"SELECT * FROM tb_shipper");
