                      ...
                      <div class="modal fade" id="delete<?= $row['item_id'];?>" role="dialog">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h4 class="modal-title"><b>[Delete]</b> Pricing/Rate</h4>
                            </div>
                            <form method="post" action=" ">
                              <div class="modal-body">
                                  <div class="form-group">
                                    <label>Are you sure delete this Pricing/Rate?</label>
                                    <h6>Type Pricing/Rate : <?= $row['item_type'];?></h6>
                                    <input type="hidden" name="uid" class="form-control" value="<?= $row['item_id'];?>" required>
                                  </div>
                                  <div class="form-group">
                                    <h6>Vendor Name : <?= $row['vendorname'];?></h6>
                                  </div>
                                  <div class="form-group">
                                    <h6>Pricing/Rate : <?= $row['price'];?></h6>
                                  </div>
                                  <div class="form-group">
                                    <h6>Remarks <br> <?= $row['remark'];?></h6>
                                  </div>
                              </div>
                              <div class="modal-footer">
