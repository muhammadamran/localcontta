...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Export - <i>Report Process</i></h1>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- /.row -->
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <form action="export_report_to_csv.php" method="get">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($con,"SELECT * FROM tb_record_master INNER JOIN tb_record_miles ON tb_record_master.rcd_id=tb_record_miles.rcd_id  WHERE tb_record_master.rcd_type = 'export' AND tb_record_master.rcd_create_month='$monthnow' AND tb_record_master.rcd_create_year='$yearnow'");
                      ...
                      <div class="modal-body"> 
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                                  <label>CK5 FILE</label>
                                  <a href="<?php echo $arr['rcd_arr_ck5_file'];?>" target="_BLANK"><button class="#">View</button></a>
                                </div>
                            <div class="form-group">
                              <label>Remarks</label>
                        ...
                        <div class="col-md-12">
                          <div class="col-md-12">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="peb_nopen" value="<?php echo $cus['rcd_cus_peb_nopen'];?>"  class="form-control"  readonly>
                            </div>
                            <div class="form-group">
